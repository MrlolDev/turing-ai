...
export default function Chat() {
  ...
  function generateImage() {
    // based on the messages generate an image to share
    ...
    ctx.fillStyle = "#000";
    ctx.font = "30px Arial";
    ctx.fillText("Alan AI", 20, 40);
    ctx.font = "20px Arial";
    ctx.fillText("Generated by Alan AI", 20, 70);
    ctx.font = "20px Arial";
    ctx.fillText("https://alan.app", 20, 100);
    ctx.font = "20px Arial";
    ...
    messages.forEach((message) => {
      ...
      ctx.font = "20px Arial";
      ctx.fillText(message.text, 20, y);
      y += 30;
    });
